...
/**
 * The AnimaitonReader class is used as support to parse a file and used to
 * create a model.
 * 
 * @author alann
 *
...
public class AnimationReader {
   ...
   * @return
   */
  public static IModel parseFile(Readable readable, AnimationBuilder<IModel> builder) {
  ...
  private static void readCanvas(Scanner s, AnimationBuilder<IModel> builder) {
    int[] vals = new int[4];
  ...
  private static void readShape(Scanner s, AnimationBuilder<IModel> builder) {
    String name;
    String type;
    if (s.hasNext()) {
      name = s.next();
  ...
  private static void readMotion(Scanner s, AnimationBuilder<IModel> builder) {
